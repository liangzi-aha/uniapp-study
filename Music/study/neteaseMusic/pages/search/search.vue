			...
			<scroll-view scroll-y="true">
				...
				<block v-if="searchType == 1">
					...
					<view class="search-hot">
						...
						<view class="search-hot-item" @tap="handleToWord(item.searchWord)"
				...
				<block v-else-if="searchType == 3">
					<view class="search-suggesr">
						...
						<view class="search-suggesr-item" @tap="handleToWord(item.keyword)" v-for="(item,index) in searchSuggest" :key="index">
							<text class="iconfont icon-search"></text>
							{{item.keyword}}
						</view>
					</view>
